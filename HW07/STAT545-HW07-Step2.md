...
Urban_plot <- Internet_Urban %>%
    ...
    labs( 
        subtitle="Internet Usage and Urban Density, 2008-15", 
        caption="source: UN",
...
GNI_plot <- Internet_GNI %>%
    ...
    geom_smooth(method=lm) +
    labs(
        subtitle="Internet Usage and Gross National Income, 2008-15", 
        caption="source: UN",
...
Elect_plot <- Internet_Electricity %>%
    ...
    geom_smooth(method=lm) +
    labs( 
        subtitle="Internet Usage and Access to Electricity, 2008-15", 
        caption="source: UN",
...
Life_plot <- Internet_Life %>%
    ...
    geom_smooth(method=lm) +
    labs( 
        subtitle="Internet Usage and Median Life Expectancy, 2008-15", 
        caption="source: UN",
